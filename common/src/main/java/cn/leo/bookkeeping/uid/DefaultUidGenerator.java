 ...
 */
package cn.leo.bookkeeping.uid;

import cn.leo.bookkeeping.util.BaseDateUtils;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    /** Customer epoch, unit as second. For example 2020-05-20 (ms: 1589904000000)*/
    ...
    /** Spring property */
    @Resource(name = "disposableWorkerIdAssignerServiceImpl")
    private WorkerIdAssignerService workerIdAssignerService;
