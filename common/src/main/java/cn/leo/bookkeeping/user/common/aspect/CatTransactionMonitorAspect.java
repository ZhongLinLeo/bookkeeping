package cn.leo.bookkeeping.user.common.aspect;

import cn.leo.bookkeeping.user.common.annotation.CatTransactionMonitor;
import cn.leo.bookkeeping.user.common.config.CatMonitorThreadLocalInfo;
import cn.leo.bookkeeping.user.common.constant.CatMonitorConstants;
...
public class CatTransactionMonitorAspect {
    ...
    @Pointcut("@annotation(cn.leo.bookkeeping.user.common.annotation.CatTransactionMonitor)")
